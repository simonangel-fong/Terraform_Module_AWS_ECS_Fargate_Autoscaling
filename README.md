...
docker run --rm --name k6_con --net=host -p 5665:5665 -e MAX=500 -e K6_WEB_DASHBOARD=true -e K6_WEB_DASHBOARD_EXPORT=load.html -e BASE_URL=https://demo-ecs-autoscaling.arguswatcher.net/ -e DURATION=300 -v ./:/app k6 run local_load.js
```
